    ...
    <section id="contact" className="py-24 bg-slate-900 relative">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Contact Info */}
          <div>
            <h2 className="text-indigo-400 font-semibold tracking-wide uppercase mb-3">Kontak Kami</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">Mulai Proyek Anda Hari Ini</h3>
            <p className="text-slate-400 text-lg mb-10 leading-relaxed">
              Siap mentransformasi bisnis Anda dengan teknologi? Hubungi kami via WhatsApp atau DM Instagram untuk respon cepat.
            </p>

            <div className="space-y-6">
              <a href="https://wa.me/6285705041136" target="_blank" rel="noreferrer" className="flex items-start group">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1 group-hover:text-indigo-400 transition-colors">WhatsApp</h4>
                  <p className="text-slate-400">0857-0504-1136</p>
                </div>
              </a>

              <a href="https://www.instagram.com/uneeddeveloper/" target="_blank" rel="noreferrer" className="flex items-start group">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1 group-hover:text-pink-400 transition-colors">Instagram</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-400">hello@uneeddeveloper.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Kantor Studio</h4>
                  <p className="text-slate-400">Digital Park Tower, Lt. 3<br/>Jakarta Selatan, Indonesia</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-800/50 p-8 rounded-3xl border border-slate-700 shadow-xl backdrop-blur-sm">
            <div className="mb-6">
              <h4 className="text-xl font-bold text-white mb-2">Kirim Pesan Langsung</h4>
              <p className="text-slate-400 text-sm">Form ini akan membuka WhatsApp Anda dengan pesan yang sudah terisi.</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="service" className="block text-sm font-medium text-slate-300 mb-2">Layanan yang Dibutuhkan</label>
                <select
                  id="service"
                  name="service"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-slate-300 mb-2">Detail Proyek</label>
                <textarea
                  id="message"
                  name="message"
                  rows={4}
